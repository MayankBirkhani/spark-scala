...
// Removing ambiguity from columns. 2 ways implemented.
// how to deal with Nulls

object DataFramesExample20 extends App{
  ...
  .load()  
    ...
    // Implementing Simple Join
  val joinedDF = ordersDf.join(customersDF,ordersDf.col("cust_id") === customersDF.col("customer_id"),"inner")
//  .drop("customer_id")           //Second way to handle. Drop the ambigous col from one of the table
